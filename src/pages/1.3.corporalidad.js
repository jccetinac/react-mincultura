  ...
  return (
    <div className="page card ">
     ...
     Más allá de la multiplicidad de nociones sobre el cuerpo, en las músicas de tradición oral la corporalidad es parte fundamental del aprendizaje y de la vida cultural: la fuerza física desarrollada por aquellos que labran la tierra hace que el rasgueo de sus tiples sea fuerte y sonoramente diferente al de los intérpretes de las ciudades. El baile que acompaña la vida de los niños y niñas desde su primera infancia, se relaciona profundamente con un específico sentido del ritmo en los músicos del Chocó. Estos, entre muchos otros ejemplos, señalan la forma en que cuerpo y música no están disociados en las músicas de tradición oral, entre otras razones, porque en las comunidades orales (como en las demás) el cuerpo es el soporte mismo de la existencia y de la identidad:
      ...
      <em>
      “Es decir, en el cuerpo y en su forma de comprenderlo, construimos nuestras subjetividades (Pedraza, 1996). Desde esta perspectiva, en la estética del cuerpo se forman también las éticas de los sujetos y las formas de percibir y sentir. Sonido y movimiento, en interacción conjunta, pasan por los filtros culturales y sociales de ese cuerpo construido y su forma de percibirlo son el marco referencial de las artes. Lo grueso y lo fino, lo fuerte y lo débil, lo duro y lo blando, lo  estridente y lo suave, con todos sus  matices, pasan a ser parte de un abanico de sensaciones que marcan el cuerpo social, el ser social y sus formas de percibir y darle forma a una realidad.” (Arango, Velo que Bonito. Prácticas y saberes sonoro-corporales de la primera infancia en la población afrochocoana., 2014, pág. 200)
      </em>
